    ...
    <div className="auth-container">
      ...
      <div className="auth-card">
        <div className="auth-header">
          <div className="auth-icon" style={{backgroundColor: '#05966920'}}>
            <span style={{color: '#059669'}}>👨‍🎓</span>
          </div>
          <h1 style={{color: '#059669'}}>Student Account</h1>
          <p>{isLogin ? 'Welcome back, learner!' : 'Start your learning journey'}</p>
        </div>
        ...
        {!isLogin && step === 1 ? (
          <form onSubmit={handleSchoolSubmit} className="auth-form">
            ...
            <div className="form-group">
              ...
              <small>Select your school from the list. Ask your teacher if you can't find it.</small>
            </div>
          ...
          <form onSubmit={handleSubmit} className="auth-form">
            ...
            {!isLogin && <div className="step-indicator">Step 2 of 2: Your Details</div>}
