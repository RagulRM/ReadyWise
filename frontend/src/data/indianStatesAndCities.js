 ...
 * Complete list of all Indian states/UTs and their major cities
 */
...
export const indianStatesAndCities = {
  ...
  "Arunachal Pradesh": [
    ...
    "Bomdila", "Tezu", "Ziro", "Along", "Changlang",
    "Khonsa", "Seppa", "Roing", "Daporijo", "Anini"
  ],
  "Assam": [
    "Guwahati", "Silchar", "Dibrugarh", "Jorhat", "Nagaon",
    "Tinsukia", "Tezpur", "Bongaigaon", "Karimganj", "Dhubri",
    "Goalpara", "Barpeta", "Sivasagar", "Diphu", "North Lakhimpur",
    "Golaghat", "Haflong", "Kokrajhar", "Hailakandi", "Hojai"
  ],
  "Bihar": [
    "Patna", "Gaya", "Bhagalpur", "Muzaffarpur", "Darbhanga",
    "Purnia", "Arrah", "Begusarai", "Katihar", "Munger",
    "Chhapra", "Saharsa", "Sasaram", "Hajipur", "Dehri",
  ...
  "Gujarat": [
    ...
    "Veraval", "Porbandar", "Godhra", "Bhuj", "Ankleshwar",
    "Gandhidham", "Mehsana", "Palanpur", "Valsad", "Botad"
  ],
  "Haryana": [
  ...
  "Himachal Pradesh": [
    ...
    "Palampur", "Baddi", "Nahan", "Sundernagar", "Una",
    "Hamirpur", "Chamba", "Bilaspur", "Kangra", "Nalagarh"
  ],
  "Jharkhand": [
    "Ranchi", "Jamshedpur", "Dhanbad", "Bokaro", "Deoghar",
    "Hazaribagh", "Giridih", "Ramgarh", "Medininagar", "Chirkunda",
    "Phusro", "Dumka", "Sahibganj", "Chaibasa", "Gumla"
  ],
  "Karnataka": [
    "Bangalore", "Mysore", "Hubli", "Mangalore", "Belgaum",
    "Gulbarga", "Davanagere", "Bellary", "Bijapur", "Shimoga",
    "Tumkur", "Raichur", "Bidar", "Hospet", "Hassan",
    "Gadag-Betigeri", "Udupi", "Robertson Pet", "Bhadravati", "Chitradurga",
    "Kolar", "Mandya", "Chikmagalur", "Gangavati", "Bagalkot"
  ],
  "Kerala": [
    "Thiruvananthapuram", "Kochi", "Kozhikode", "Thrissur", "Kollam",
    "Palakkad", "Alappuzha", "Malappuram", "Kannur", "Kottayam",
    "Thalassery", "Ponnani", "Vatakara", "Kanhangad", "Payyanur",
    "Koyilandy", "Parappanangadi", "Kalamassery", "Neyyattinkara", "Tanur"
  ],
  "Madhya Pradesh": [
  ...
  "Maharashtra": [
    ...
    "Jalna", "Ambarnath", "Bhusawal", "Panvel", "Bhiwandi",
    "Nanded", "Gondia", "Satara", "Wardha", "Udgir"
  ],
  "Manipur": [
    "Imphal", "Thoubal", "Lilong", "Mayang Imphal", "Kakching",
    "Bishnupur", "Churachandpur", "Senapati", "Ukhrul", "Moreh"
  ],
  "Meghalaya": [
    "Shillong", "Tura", "Nongstoin", "Jowai", "Baghmara",
    "Williamnagar", "Nongpoh", "Resubelpara", "Mairang", "Cherrapunji"
  ],
  "Mizoram": [
    "Aizawl", "Lunglei", "Saiha", "Champhai", "Kolasib",
    "Serchhip", "Mamit", "Lawngtlai", "Hnahthial", "Saitul"
  ],
  "Nagaland": [
  ...
  "Odisha": [
    ...
    "Jeypore", "Bargarh", "Balangir", "Rayagada", "Bhawanipatna",
    "Dhenkanal", "Barbil", "Kendujhar", "Sunabeda", "Paradip"
  ],
  "Punjab": [
  ...
  "Rajasthan": [
    ...
    "Pali", "Sri Ganganagar", "Tonk", "Beawar", "Dhaulpur",
    "Barmer", "Hanumangarh", "Kishangarh", "Churu", "Jhunjhunu",
    "Nagaur", "Bundi", "Chittorgarh", "Sawai Madhopur", "Jaisalmer"
  ],
  "Sikkim": [
    "Gangtok", "Namchi", "Gyalshing", "Mangan", "Jorethang",
    "Rangpo", "Singtam", "Ravangla", "Yuksom", "Pelling"
  ],
  "Tamil Nadu": [
    ...
    "Kumarapalayam", "Karaikkudi", "Paramakudi", "Karur", "Kumbakonam"
  ],
  "Telangana": [
  ...
  "Tripura": [
    ...
    "Khowai", "Ambassa", "Teliamura", "Sabrum", "Amarpur"
  ],
  "Uttar Pradesh": [
    ...
    "Ayodhya", "Hapur", "Etawah", "Mirzapur", "Bulandshahr",
    "Sambhal", "Amroha", "Hardoi", "Fatehpur", "Raebareli"
  ],
  "Uttarakhand": [
    "Dehradun", "Haridwar", "Roorkee", "Haldwani", "Rudrapur",
    "Kashipur", "Rishikesh", "Pithoragarh", "Ramnagar", "Pauri",
    "Kotdwar", "Nainital", "Almora", "Tehri", "Bageshwar"
  ],
  "West Bengal": [
  ...
  "Andaman and Nicobar Islands": [
    ...
    "Havelock Island", "Neil Island", "Little Andaman", "Baratang"
  ],
  "Chandigarh": [
    "Chandigarh"
  ],
  ...
  "Delhi": [
    ...
    "Shahdara", "Dwarka", "Rohini", "Karol Bagh", "Najafgarh"
  ],
  "Jammu and Kashmir": [
    "Srinagar", "Jammu", "Anantnag", "Baramulla", "Sopore",
    "Kathua", "Udhampur", "Rajouri", "Kupwara", "Pulwama",
    "Ganderbal", "Budgam", "Bandipora", "Kulgam", "Poonch"
  ],
  "Ladakh": [
...
export const getCitiesByState = (stateName) => {
  return indianStatesAndCities[stateName] || [];
};
...
export const searchCities = (searchTerm) => {
  ...
  Object.entries(indianStatesAndCities).forEach(([state, cities]) => {
    cities.forEach(city => {
